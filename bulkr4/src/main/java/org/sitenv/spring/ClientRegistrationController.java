...
public class ClientRegistrationController {
    ...
    @ResponseBody
    public DafClientRegister registerBackendClient(@RequestParam HashMap<String,String> params,HttpServletRequest request) throws OAuthSystemException, FHIRHapiException {
