...
public class AllergyIntoleranceDaoImpl extends AbstractDao implements AllergyIntoleranceDao {
	...
	public List<DafAllergyIntolerance> getAllergyIntoleranceForBulkData(StringJoiner patients, Date start) {
		List<DafAllergyIntolerance> list = null;
		try {
			StringBuffer stb = new StringBuffer();
			stb.append("select * from allergy where data->").append("'").append("patient").append("'").append("->>")
		...
		//	System.out.println("query..." + query);
			list = getSession().createNativeQuery(query, DafAllergyIntolerance.class).getResultList();
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
