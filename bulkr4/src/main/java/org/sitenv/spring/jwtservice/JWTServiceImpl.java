...
public class JWTServiceImpl implements JWTService {
	 ...
	 */
	public JWTServiceImpl(Map<String, JWK> keys) throws NoSuchAlgorithmException, InvalidKeySpecException {
		this.keys = keys;
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public JWTServiceImpl(JWKSStore keyStore) throws NoSuchAlgorithmException, InvalidKeySpecException {
