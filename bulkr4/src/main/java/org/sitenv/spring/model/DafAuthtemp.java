...
public class DafAuthtemp {
	...
	public String toString() {
		return "DafAuthtemp [id=" + id + ", client_id=" + client_id + ", client_secret=" + client_secret + ", authCode="
				+ authCode + ", access_token=" + access_token + ", aud=" + aud + ", expiry=" + expiry + ", scope="
				+ scope + ", state=" + state + ", redirect_uri=" + redirect_uri + ", transaction_id=" + transaction_id
				+ ", refresh_token=" + refresh_token + ", launchPatientId=" + launchPatientId + ", idToken=" + idToken
				+ "]";
	}
