(function(){
	 ...
	 var main_url = geturl();
	 //var main_url = "http://localhost:8080/secure-fhir";
	...
	$(document).ready(function(){
		$("#jwkquery").change(function () {
			console.log('fasdfas', this.checked);
			console.log('fasdfas', document.getElementById('jku'));
			document.getElementById('jku').disabled = !this.checked;
//		      $('#jku').attr("disabled", !this.checked);
		});
		
//		$("#jwktoken").change(function () {
//		      $('#publickeytextarea').attr("disabled", this.checked);
//		});
				...
				$('#registerbackendclientdetails').formValidation({
		            ...
		            fields: {
		                ...
		                jku: {
		                	 validators: {
			                        notEmpty: {
			                            message: 'Public Key URL/jku is required'
			                        }
			                    }
		                },
		               	'scopes[]': {
					...
					var publickeyurlOrjku = $('#jku').val();
					var publickeytextarea = $("#publickeytextarea").val()
					...
					formData.append('publickeyurlOrjku',publickeyurlOrjku);
					formData.append('publickeytextarea',publickeytextarea);
