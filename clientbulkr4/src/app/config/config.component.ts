...
export class ConfigComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.siteServersList = [
      'http://localhost:8081/secure-fhir/fhir',
      'https://fhir.sitenv.org/open-fhir/fhir',
      'https://fhir.sitenv.org/secure-fhir/fhir',
      'https://fhir.sitenv.org/open-fhir/fhir',
      'https://fhir.sitenv.org/secure-fhir/fhir',
      'https://fhir.sitenv.org/fhir-backend/fhir',
      'https://fhir.sitenv.org/fhir-backend/fhir',
      'https://fhir.sitenv.org/secure-fhir/fhir',
      'https://fhir.dev.sitenv.org/secure-fhir/fhir',
      'https://fhir.dev.sitenv.org/open-fhir/fhir',
      'http://localhost:8081/bulkr4/fhir',
      'https://fhir.dev.sitenv.org/bulkr4/fhir',
      'https://fhirsandbox.healthit.gov/bulkr4/fhir'
  ...
  tryme(mode) {
    if (mode === 'open') {
      this.fhirURL = 'https://fhir.dev.sitenv.org/open-fhir/fhir';
      this.openMode = true;
      ...
      this.myForm.setValue({
        mode: 'open',
        openurlFormControl: 'https://fhir.dev.sitenv.org/open-fhir/fhir',
