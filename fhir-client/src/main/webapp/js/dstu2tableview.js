(function () {
    dstu2tableview = function (resourcename, data, tab) {
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                if (jsondata.category) {
                    if (typeof jsondata.category == 'object') {
                        var codeol = $('<ol style="list-style-type:none;padding:0px;"></ol>');
                        var codetd1 = $("<li></li>");
                        if (jsondata.category[0].coding[0]) {
        ...
        if (resourcename == 'Device') {
            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Status</th><th>Patient</th><th>UDI</th><th>Identifier</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                var td3 = $("<td></td>");
                if (jsondata.patient) {
                    td3.append(jsondata.patient.reference);
                }

                var td4 = $("<td></td>");
                if (jsondata.udi) {
                    td4.append(jsondata.udi);
                }
        ...
        if (resourcename == 'Goal') {
            ...
            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Subject</th><th>Start-Date</th><th>Description</th><th>Status</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                if (jsondata.startDate) {
                    td3.append(jsondata.startDate);
                }

                var td4 = $("<td></td>");
                if (jsondata.description) {
                    td4.append(jsondata.description);
                }
                var td5 = $("<td></td>");
                if (jsondata.status) {
                    td5.append(jsondata.status);
                }
        ...
        if (resourcename == 'DiagnosticReport') {
            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Identifier</th><th>Status</th><th>Category</th><th>Subject</th><th>Issued</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                if (jsondata.position) {
                    if (typeof jsondata.position == 'object') {
                        ...
                        var positionol = $('<ol style="list-style-type:none;padding:0px;"></ol>');
                        var positiontd1 = "<li><b>Longitude</b>: " + jsondata.position.longitude + "</li>";
                        var positiontd2 = "<li><b>Latitude</b>:" + jsondata.position.latitude + "</li>";
                        var positiontd3 = "<li><b>Altitude</b>:" + jsondata.position.altitude + "</li>"
                        positionol.append(positiontd1, positiontd2, positiontd3);
                        td5.append(positionol);
                    }
                }
        ...
        if (resourcename == 'Medication') {
            ...
            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Code</th><th>Manufacturer</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            if(noofresults.length === 0){
                var tr=$("<tr/>");
                var td = $('<td style="text-align:center;" colspan="3">No records Found</td>');
                tr.append(td);
                $("#JSONtable").append(tr);
                return;
            }
            for (var i = 0; i < noofresults.length; i++) {
                ...
                if (jsondata.manufacturer) {
                    td3.append(jsondata.manufacturer.reference);
                }
        ...
        if (resourcename == 'MedicationOrder') {

            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Status</th><th>Patient</th><th>DateWritten</th><th>MedicationCodeableConcept</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                var td4 = $("<td></td>");
                if (jsondata.dateWritten) {
                    td4.append(jsondata.dateWritten);
                }
                var td5 = $('<td></td>');
                if (jsondata.medicationCodeableConcept) {
                    if (typeof jsondata.medicationCodeableConcept == 'object') {
        ...
        if (resourcename == 'Organization') {
            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Name</th><th>Active</th><th>Address</th><th>Identifier</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                var td2 = $('<td></td>');
                if (jsondata.name) {
                    td2.append(jsondata.name);
                }

                var td3 = $('<td></td>');
                if (jsondata.active) {
                    td3.append(jsondata.active);
                }
                ...
                if (jsondata.address) {
                    if (typeof jsondata.address == 'object') {
                        var codeol = $('<ol style="list-style-type:none;padding:0px;"></ol>');
                        var codetd1 = $("<li></li>");
                        if (jsondata.address[0].use) {
                            codetd1.append("<b>Use</b>: " + jsondata.address[0].use);
                        }
                        var codetd2 = $("<li></li>");
        ...
        if (resourcename == 'Practitioner') {
            table = $('<table class="table table-bordered table-striped" id="JSONtable" ></table>');
            thead = $('<thead></thead>');
            tr = $('<tr class="info" text-align="center"><th>Id</th><th>Name</th><th>Identifier</th><th>Telecome</th><th>PractitionerRole</th></tr>');
            thead.append(tr);
            table.append(thead);
            results.append(table);
            var noofresults = [];
            ...
            for (var i = 0; i < noofresults.length; i++) {
                ...
                var td2 = $('<td></td>');
                if (jsondata.name.given[0]) {
                    td2.append(jsondata.name.given[0]);
                }
                ...
                if (jsondata.identifier) {
                    if (typeof jsondata.identifier == 'object') {
                        var identifier = jsondata.identifier;
                        var identifierol = $('<ol style="list-style-type:none;padding:0px;"></ol>');
                        var identifiertd1 = "<li><b>Use</b>: " + jsondata.identifier[0].use + "</li>";
                        var identifiertd2 = "<li><b>System</b>: " + jsondata.identifier[0].system + "</li>";
                        var identifiertd3 = "<li><b>Value</b>:" + jsondata.identifier[0].value + "</li>";
                        identifierol.append(identifiertd1, identifiertd2, identifiertd3);
                        td3.append(identifierol);
                    }
                }
                ...
                if (jsondata.telecom) {
                    if (typeof jsondata.telecom == 'object') {
                        var telecom = jsondata.telecom;
                        var telecomol = $('<ol style="list-style-type:none;padding:0px;"></ol>');

                        var telecomtd1 = "<li><b>System</b>: " + jsondata.telecom[0].system + "</li>";
                        var telecomtd2 = "<li><b>Value</b>:" + jsondata.telecom[0].value + "</li>";
                        var telecomtd3 = "<li><b>Use</b>: " + jsondata.telecom[0].use + "</li>";
                        telecomol.append(telecomtd1, telecomtd2, telecomtd3);
                        td4.append(telecomol);
                    }
                }
                var td5 = $('<td></td>');
                if (jsondata.practitionerRole) {
                    if (typeof jsondata.practitionerRole[0].role.coding[0] == 'object') {
                        var codeol = $('<ol style="list-style-type:none;padding:0px;"></ol>');
                        var codetd1 = $("<li></li>");
                        if (jsondata.practitionerRole[0].role.coding[0]) {
                            if (jsondata.practitionerRole[0].role.coding[0].code) {
                                codetd1.append("<b>Code</b>: " + jsondata.practitionerRole[0].role.coding[0].code);
                            }

                            codeol.append(codetd1);
                            td5.append(codeol);
                        }
