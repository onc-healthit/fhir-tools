(function(){
	...
	var docreftrigger = 0;
	var docrefByPatientId = "docrefByPatientId";
	var docrefCollapseByPatientId = "docrefCollapseByPatientId";
	var docrefByPatientIdType = "docrefByPatientIdType";
	var docrefCollapseByPatientIdType = "docrefCollapseByPatientIdType";
	var docrefByPatientIdTypePeriod = "docrefByPatientIdTypePeriod";
	var docrefCollapseByPatientIdTypePeriod = "docrefCollapseByPatientIdTypePeriod";
	var docrefByextandPatientId = "docrefByextandPatientId";
	var docrefCollapseByextandPatientId = "docrefCollapseByextandPatientId";
	var l = $( '#executebtn' ).ladda();
	docrefByPatId = function(strurl){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	docrefsuccesscount++;
	          	$('.docrefrunByPatId').html('Passed');
	          	if(docreftrigger == 0){
	          		$('.docrefrun').html('Passed');
	          	}
	          	$('.docrefpass').html(docrefsuccesscount);
	          	$('#authsuccess').html('');
		        ...
		        docrefByPatientIdandType(strurl,data,docrefByPatientIdType,docrefCollapseByPatientIdType);
		        docrefByPatientIdTypeandPeriod(strurl,data,docrefByPatientIdTypePeriod,docrefCollapseByPatientIdTypePeriod);
		        docrefByextendedoperation(strurl,data,docrefByextandPatientId,docrefCollapseByextandPatientId);
	          	renderdocrefresults(data,strurl,xhr,docrefByPatientId,docrefCollapseByPatientId,resType);
	          	l.ladda('stop');
	        },
	        error:function(e){
	        	docreftrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.docrefrunByPatId').html('Failed');
	        	$('.docrefrun').html('Failed');
	        	$('.docrefrun').parent().addClass('bg-danger');
	        	renderdocreferror(e,docrefByPatientId);
	   		}
		})
	}

	docrefByPatientIdandType = function(strurl,data,docrefByPatientIdType,docrefCollapseByPatientIdType){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	docrefsuccesscount++;
	          	$('.docrefrunByPatIdType').html('Passed');
	          	if(docreftrigger == 0){
	          		$('.docrefrun').html('Passed');
	          	}
	          	$('.docrefpass').html(docrefsuccesscount);
	          	renderdocrefresults(data,strurl,xhr,docrefByPatientIdType,docrefCollapseByPatientIdType,resType);
	        },
	        error:function(e){
	        	docreftrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.docrefrunByPatIdType').html('Failed');
	        	$('.docrefrun').html('Failed');
	        	$('.docrefpass').parent().addClass('bg-danger');
	        	renderdocreferror(e,docrefByPatientIdType);
	   		}
		});
	}

	docrefByPatientIdTypeandPeriod = function(strurl,data,docrefByPatientIdTypePeriod,docrefCollapseByPatientIdTypePeriod){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	docrefsuccesscount++;
	          	$('.docrefrunByPatIdTypePeriod').html('Passed');
	          	if(docreftrigger == 0){
	          		$('.docrefrun').html('Passed');
	          	}
	          	$('.docrefpass').html(docrefsuccesscount);
	          	renderdocrefresults(data,strurl,xhr,docrefByPatientIdTypePeriod,docrefCollapseByPatientIdTypePeriod,resType);
	        },
	        error:function(e){
	        	docreftrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.docrefrunByPatIdTypePeriod').html('Failed');
	        	$('.docrefrun').html('Failed');
	        	$('.docrefpass').parent().addClass('bg-danger');
	        	renderdocreferror(e,docrefByPatientIdTypePeriod);
	   		}
		});
	}

	docrefByextendedoperation = function(strurl,data,docrefByextandPatientId,docrefCollapseByextandPatientId){
		var patientid = localStorage.getItem("patientid");
		var strurl = localStorage.getItem("strurl");
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	docrefsuccesscount++;
	          	$('.docrefrunByPatIdext').html('Passed');
	          	if(docreftrigger == 0){
	          		$('.docrefrun').html('Passed');
	          	}
	          	$('.docrefpass').html(docrefsuccesscount);
	          	renderdocrefresults(data,strurl,xhr,docrefByextandPatientId,docrefCollapseByextandPatientId,resType);
	        },
	        error:function(e){
	        	docreftrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.docrefrunByPatIdext').html('Failed');
	        	$('.docrefrun').html('Failed');
	        	$('.docrefpass').parent().addClass('bg-danger');
	        	renderdocreferror(e,docrefByextandPatientId);
	   		}
		});
	}

	renderdocrefresults = function(data,strurl,xhr,trid,colbyIdentifier,resType){
			/*$('.removabletr').remove();*/
			tr = $('<tr class="docrefremovabletr"></tr>');
	...
	renderdocreferror = function(e,trid){
		var authfail;
		tr = $('<tr class="docrefremovabletr"></tr>');
		td = $('<td colspan="6" class="hiddenRow"></td>');
		if(e.status == '401'){
