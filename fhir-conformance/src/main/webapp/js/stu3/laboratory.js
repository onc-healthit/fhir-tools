(function(){
	...
	var labtrigger= 0;
	var stu3obslaboratoryByPatientCategory = "stu3obslaboratoryByPatientCategory";
	var stu3obslaboratoryCollapseByPatientCategory = "stu3obslaboratoryCollapseByPatientCategory";
	var stu3obslaboratoryByPatientCode = "stu3obslaboratoryByPatientCode";
	var stu3obslaboratoryCollapseByPatientCode = "stu3obslaboratoryCollapseByPatientCode";
	var stu3obslaboratoryByPatientCategoryDate = "stu3obslaboratoryByPatientCategoryDate";
	var stu3obslaboratoryCollapseByPatientCategoryDate = "stu3obslaboratoryCollapseByPatientCategoryDate";
	var stu3obslaboratoryByPatientCategoryCodeDate = "stu3obslaboratoryByPatientCategoryCodeDate";
	var stu3obslaboratoryCollapseByPatientCategoryCodeDate = "stu3obslaboratoryCollapseByPatientCategoryCodeDate";
	var l = $( '#executebtn' ).ladda();
	stu3obslaboratoryByPatId = function(strurl){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	$('.stu3obslaboratoryrunByPatcategory').html('Passed');
	          	if(labtrigger == 0){
	          		$('.stu3obslaboratoryrun').html('Passed');
	          	}
	          	$('.stu3obslaboratorypass').html(obslaboratorysuccesscount);
	          	$('#authsuccess').html('');
		        ...
		        $('#authsuccess').append(authsuccess);
	          	stu3obslaboratoryByPatCode(strurl,data,stu3obslaboratoryByPatientCode,stu3obslaboratoryCollapseByPatientCode);
	          	stu3obslaboratoryByPatCategoryDate(strurl,data,stu3obslaboratoryByPatientCategoryDate,stu3obslaboratoryCollapseByPatientCategoryDate);
	          	stu3obslaboratoryByPatCategoryCodeDate(strurl,data,stu3obslaboratoryByPatientCategoryCodeDate,stu3obslaboratoryCollapseByPatientCategoryCodeDate);
	          	stu3renderobslaboratoryresults(data,strurl,xhr,stu3obslaboratoryByPatientCategory,stu3obslaboratoryCollapseByPatientCategory,resType);
	          	l.ladda('stop');
	        },
	        error:function(e){
	        	labtrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.stu3obslaboratoryrunByPatcategory').html('Failed');
	        	$('.stu3obslaboratoryrun').html('Failed');
	        	$('.stu3obslaboratoryrun').parent().addClass('bg-danger');
	        	stu3renderobslaboratoryerror(e,stu3obslaboratoryByPatientCategory);
	   		}
		})
	}

	stu3obslaboratoryByPatCode = function(strurl,data,stu3obslaboratoryByPatientCode,stu3obslaboratoryCollapseByPatientCode){
		var codearr=[];
			if(data.entry){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	obslaboratorysuccesscount++;
	          	$('.stu3obslaboratoryrunByPatCode').html('Passed');
	          	if(labtrigger == 0){
	          		$('.stu3obslaboratoryrun').html('Passed');
	          	}
	          	$('.stu3obslaboratorypass').html(obslaboratorysuccesscount);
	          	stu3renderobslaboratoryresults(data,strurl,xhr,stu3obslaboratoryByPatientCode,stu3obslaboratoryCollapseByPatientCode,resType);
	        },
	        error:function(e){
	        	labtrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.stu3obslaboratoryrunByPatCode').html('Failed');
	        	$('.stu3obslaboratoryrun').html('Failed');
	        	$('.stu3obslaboratoryrun').parent().addClass('bg-danger');
	        	stu3renderobslaboratoryerror(e,stu3obslaboratoryByPatientCode);
	   		}
		});
	}

	stu3obslaboratoryByPatCategoryDate = function(strurl,data,stu3obslaboratoryByPatientCategoryDate,stu3obslaboratoryCollapseByPatientCategoryDate){
		var datearr;
			if(data.entry){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	obslaboratorysuccesscount++;
	          	$('.stu3obslaboratoryrunByPatCategoryDate').html('Passed');
	          	if(labtrigger == 0){
	          		$('.stu3obslaboratoryrun').html('Passed');
	          	}
	          	$('.stu3obslaboratorypass').html(obslaboratorysuccesscount);
	          	stu3renderobslaboratoryresults(data,strurl,xhr,stu3obslaboratoryByPatientCategoryDate,stu3obslaboratoryCollapseByPatientCategoryDate,resType);
	        },
	        error:function(e){
	        	labtrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.stu3obslaboratoryrunByPatCategoryDate').html('Failed');
	        	$('.stu3obslaboratoryrun').html('Failed');
	        	$('.stu3obslaboratoryrun').parent().addClass('bg-danger');
	        	stu3renderobslaboratoryerror(e,stu3obslaboratoryByPatientCategoryDate);
	   		}
		});
	}

	stu3obslaboratoryByPatCategoryCodeDate = function(strurl,data,stu3obslaboratoryByPatientCategoryCodeDate,stu3obslaboratoryCollapseByPatientCategoryCodeDate){
		var codearr= [];
		var datearr;
			if(data.entry){
				datearr = data.entry[0].resource.effectiveDateTime;
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	obslaboratorysuccesscount++;
	          	$('.stu3obslaboratoryrunByPatCategoryCodeDate').html('Passed');
	          	if(labtrigger == 0){
	          		$('.stu3obslaboratoryrun').html('Passed');
	          	}
	          	$('.stu3obslaboratorypass').html(obslaboratorysuccesscount);
	          	stu3renderobslaboratoryresults(data,strurl,xhr,stu3obslaboratoryByPatientCategoryCodeDate,stu3obslaboratoryCollapseByPatientCategoryCodeDate,resType);
	        },
	        error:function(e){
	        	labtrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.stu3obslaboratoryrunByPatCategoryCodeDate').html('Failed');
	        	$('.stu3obslaboratoryrun').html('Failed');
	        	$('.stu3obslaboratoryrun').parent().addClass('bg-danger');
	        	stu3renderobslaboratoryerror(e,stu3obslaboratoryByPatientCategoryCodeDate);
	   		}
		});
	}

	stu3renderobslaboratoryresults = function(data,strurl,xhr,trid,colbyIdentifier,resType){
			/*$('.removabletr').remove();*/
			tr = $('<tr class="stu3obslaboratoryremovabletr"></tr>');
	...
	stu3renderobslaboratoryerror = function(e,trid){
		var authfail;
		tr = $('<tr class="stu3obslaboratoryremovabletr"></tr>');
		td = $('<td colspan="6" class="hiddenRow"></td>');
		if(e.status == '401'){
