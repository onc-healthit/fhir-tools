(function(){
	...
	var stu3smokingstatusByPatientCategory = "stu3smokingstatusByPatientCategory";
	var stu3smokingstatusCollapseByPatientCategory = "stu3smokingstatusCollapseByPatientCategory";
	var stu3smokingstatusByPatientCode = "stu3smokingstatusByPatientCode";
	var stu3smokingstatusCollapseByPatientCode = "stu3smokingstatusCollapseByPatientCode";
	var l = $( '#executebtn' ).ladda();
	stu3smokingstatusByPatId = function(strurl){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	$('.stu3smokingstatusrunByPatcategory').html('Passed');
	          	if(smokingtrigger == 0){
	          		$('.stu3smokingstatusrun').html('Passed');
	          	}
	          	$('.stu3smokingstatuspass').html(smokingstatussuccesscount);
	          	$('#authsuccess').html('');
		        ...
		        $('#authsuccess').append(authsuccess);
	          	stu3smokingstatusByPatCode(strurl,data,stu3smokingstatusByPatientCode,stu3smokingstatusCollapseByPatientCode);
	          	stu3rendersmokingstatusresults(data,strurl,xhr,stu3smokingstatusByPatientCategory,stu3smokingstatusCollapseByPatientCategory,resType);
	          	l.ladda('stop');
	        },
	        error:function(e){
	        	smokingtrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.stu3smokingstatusrunByPatcategory').html('Failed');
	        	$('.stu3smokingstatusrun').html('Failed');
	        	$('.stu3smokingstatusrun').parent().addClass('bg-danger');
	        	stu3rendersmokingstatuserror(e,stu3smokingstatusByPatientCategory);
	   		}
		})
	}

	stu3smokingstatusByPatCode = function(strurl,data,stu3smokingstatusByPatientCode,stu3smokingstatusCollapseByPatientCode){
		var codearr=[];
			if(data.entry){
		...
		$.ajax({
	        ...
	        success:function(data,status,xhr){
	        	...
	        	if(data.entry){
	          	...
	          	smokingstatussuccesscount++;
	          	$('.stu3smokingstatusrunByPatCode').html('Passed');
	          	if(smokingtrigger == 0){
	          		$('.stu3smokingstatusrun').html('Passed');
	          	}
	          	$('.stu3smokingstatuspass').html(smokingstatussuccesscount);
	          	stu3rendersmokingstatusresults(data,strurl,xhr,stu3smokingstatusByPatientCode,stu3smokingstatusCollapseByPatientCode,resType);
	        },
	        error:function(e){
	        	smokingtrigger = 1;
	        	l.ladda( 'stop' );
	        	$('.stu3smokingstatusrunByPatCode').html('Failed');
	        	$('.stu3smokingstatusrun').html('Failed');
	        	$('.stu3smokingstatusrun').parent().addClass('bg-danger');
	        	stu3rendersmokingstatuserror(e,stu3smokingstatusByPatientCode);
	   		}
		});
	}

	stu3rendersmokingstatusresults = function(data,strurl,xhr,trid,colbyIdentifier,resType){
			/*$('.removabletr').remove();*/
			tr = $('<tr class="stu3smokingstatusremovabletr"></tr>');
	...
	stu3rendersmokingstatuserror = function(e,trid){
		var authfail;
		tr = $('<tr class="stu3smokingstatusremovabletr"></tr>');
		td = $('<td colspan="6" class="hiddenRow"></td>');
		if(e.status == '401'){
