...
<div class="container" style="margin-top:15px;">
    ...
    <h5 class="form-signin-heading" style="text-align:center;"><i>For demo users use Username: <b>demouser</b> Password:
        <b>Demouser1!</b></i></h5>
        ...
        <div _ngcontent-vni-31="" class="container" role="contentinfo">
            <div _ngcontent-vni-31="" class="row">
                ...
                <div _ngcontent-vni-31="" class="col-sm-6 text-right">
                    Inquiries or questions, email <a _ngcontent-vni-31="" href="mailto:edge-test-tool@googlegroups.com"
                                                     tabindex="100">edge-test-tool@googlegroups.com</a>
                </div>
            </div>
            <div _ngcontent-vni-31="" class="row">
                <div _ngcontent-vni-31="" class="col-sm-6 text-left">
