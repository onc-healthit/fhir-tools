...
public class DafCondition {
    ...
    public Date getAsserted_date() {
        return asserted_date;
    }

    public void setAsserted_date(Date asserted_date) {
        this.asserted_date = asserted_date;
    }
