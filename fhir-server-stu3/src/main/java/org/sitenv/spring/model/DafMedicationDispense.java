...
public class DafMedicationDispense {
    ...
    private DafMedicationRequest authorizingprescription;
    ...
    public DafMedicationRequest getAuthorizingprescription() {
        return authorizingprescription;
    }

    public void setAuthorizingprescription(
            DafMedicationRequest authorizingprescription) {
