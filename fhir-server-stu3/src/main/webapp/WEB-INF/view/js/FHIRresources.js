...
var fhirresources = {
    'labels': {
        ...
        'DiagnosticReport': 'DAFDiagnosticReport',
        'Encounter': 'DAFEncounter',
        'FamilyMemberHistory': 'DAFFamilyMemberHistory',
        'Immunization': 'DAFImmunization',
        //'Observation':'DAFLabResults',
        'Medication': 'DAFMedication',
        'MedicationStatement': 'DAFMedicationStatement',
        'MedicationAdministration': 'DAFMedicationAdministration',
        'Patient': 'DAFPatient',
        'Condition': 'DAFCondition (Problem)',
        'Procedure': 'DAFProcedure',
        //'Observation':'DAFSmokingStatus',
        //'Observation':'DAFVitalSigns',
        'List': 'DAFList',
        'DocumentReference': 'Argonaut Document Reference'
    },
}
