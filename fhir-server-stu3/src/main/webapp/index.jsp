                ...
                <nav class="collapse navbar-collapse" id="navigation">
                    <ul class="nav navbar-nav">
                        <li><a routerlink="/" routerlinkactive="active"
                               tabindex="1" title="SITE Home" href="https://sitenv.org/home" class="active">Home</a>
                        </li>
...
<div class="container" style="margin-top:10px;">
    ...
    <div class="col-md-12">
        <div class="col-md-12" align="center" style="font-size:16px;">
            <p>This is an implementation of the FHIR standard using the <a
                    href="http://hl7.org/fhir/us/daf/2016Sep/daf-core.html" target="_blank">DAF-Core Implementation
                guide</a>. We expect client developers to use the server as part of their development activities to work
                with different data sets. </p>
            <hr>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div style="background-image:linear-gradient(to bottom, #f5f5f5 0%, #e8e8e8 100%);background-repeat:repeat-x"
                 class="panel-heading">
                <h3 style="margin:5px;font-size:20px">Instructions and Guidelines to use the FHIR Server:</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                    The FHIR Server can be used in two modes. An open mode (No OAuth token required) and a secure mode
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default" style="min-height:300px;">
                            ...
                            <div class="panel-body">
                                A client can use the open server by making a FHIR request using a FHIR READ or SEARCH
                                operation.
	                ...
	                ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort() )
	                 %>/open/fhir/Patient/1" target="_blank"><%=request.getScheme() + "://" +
                                                    request.getServerName() +
                                                    ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort()) %>
                                                /open/fhir/Patient/1</a> - XML format.
                                            </li>
                                            <li>GET <a href="<%=request.getScheme() + "://" +
	                request.getServerName() +
	                ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort() ) %>/open/fhir/Patient/1?_format=json"
                                                       target="_blank"><%=request.getScheme() + "://" +
                                                    request.getServerName() +
                                                    ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort()) %>
                                                /open/fhir/Patient/1?_format=json</a> - JSON format.
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul style="list-style:outside none disc;margin-bottom:8px;">
                                            <li>GET <a href="<%=request.getScheme() + "://" +
	                request.getServerName() +
	                ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort() ) %>/open/fhir/Patient/?_id=1"
                                                       target="_blank"><%=request.getScheme() + "://" +
                                                    request.getServerName() +
                                                    ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort()) %>
                                                /open/fhir/Patient/?_id=1</a> - XML format.
                                            </li>
                                            <li>GET <a href="<%=request.getScheme() + "://" +
	                request.getServerName() +
	                ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort() ) %>/open/fhir/Patient/?_id=1&_format=json"
                                                       target="_blank"><%=request.getScheme() + "://" +
                                                    request.getServerName() +
                                                    ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort()) %>
                                                /open/fhir/Patient/?_id=1&_format=json</a> - JSON format.
                                            </li>
                                        </ul>
                                    </li>
                                    <li style="margin-bottom:8px;">
                                        Click here for more details on <a href="http://hl7.org/fhir/search.html"
                                                                          target="_blank">FHIR Search</a>.
                                    </li>
                                    <li>
                                        For a list of Patients <a style="cursor:pointer;"
                                                                  onclick="openpatientlistmodal();">Click here</a>.
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default" style="min-height:300px;">
                            ...
                            <div class="panel-body">
                                <ol>
                                    <li>
                                        The Secure FHIR server follows the implementation of Smart On FHIR
                                        specifications.
                                    </li>
                                    <li>
                                        In order to use the FHIR Server with the appropriate tokens the following steps
                                        need to be followed
                                        <ul style="list-style:outside none disc;">
                                            <li style="margin-bottom:8px;">
                                                Create a user account in the FHIR Authorization Server:
                                                Follow instructions <a href="view/newuser.html" target="_blank">here</a>
                                                for user creation.
                                            </li>
                                            <li style="margin-bottom:8px;">
                                                Login and Register a client so that you can get the Client Id and Client
                                                Secret.
                                                Follow instructions <a href="view/clients.html" target="_blank">here</a>
                                                for client registration.
                                            </li>
                                            <li style="margin-bottom:8px;">
                                                Once you have a Client Id and Client Secret follow the guidelines
                                                according to the Smart On FHIR to request resources.
                                            </li>
                                        </ul>
                                    </li>
                                </ol>
            ...
            <div _ngcontent-vni-31="" class="row">
                <div _ngcontent-vni-31="" class="col-sm-6 text-left">
                    <site-news-announcements _ngcontent-vni-31="" _nghost-vni-27="">
                        <button _ngcontent-vni-27="" class="btn btn-link footer-link-btn" type="button"
                    ...
                    <site-release-notes _ngcontent-vni-31="" _nghost-vni-29="">
                        <button _ngcontent-vni-29="" class="btn btn-link footer-link-btn" type="button"
                                onclick="openreleasemodal();">Release Notes
                        </button>
                    </site-release-notes>
                </div>
                <div _ngcontent-vni-31="" class="col-sm-6 text-right">
...
<script type="text/javascript">
    ...
    loadPatients = function () {
        $('#example').dataTable({
            ...
            "bFilter": false,
            "info": false,
            "ajax": "/open/stu3/authorize/launchpatient",
            "sAjaxDataProp": "",
            "columns": [{
