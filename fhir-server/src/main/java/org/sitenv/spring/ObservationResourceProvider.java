...
public class ObservationResourceProvider implements IResourceProvider {
    ...
    public Observation getObservationResourceVitalSignsById(@RequiredParam(name = "vital-signs") ReferenceParam theId) {
        try {
			 ...
			 * unknown resource
			 */
            throw new ResourceNotFoundException("Resource vital-signs=" + theId.getIdPart() + " is not known");
        }
    }
    ...
    public Observation getObservationResourceBySocialHistoryId(
        ...
        try {
			 ...
			 * unknown resource
			 */
            throw new ResourceNotFoundException("Resource social-history=" + theId.getIdPart() + " is not known");
        }
    }
    ...
    public Observation getObservationResourceByResultsId(@RequiredParam(name = "laboratory") ReferenceParam theId) {
        try {
			 ...
			 * unknown resource
			 */
            throw new ResourceNotFoundException("Resource laboratory=" + theId.getIdPart() + " is not known");
        }
    }
