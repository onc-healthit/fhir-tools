                                        ...
                                        <ul style="list-style:outside none disc;">
                                            <li style="margin-bottom:8px;">
                                                ...
                                                Follow instructions <a href="<%=request.getScheme() + "://" +
                                                    request.getServerName() +
                                                    ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort() )
                                            %>/secure/view/newuser.html" target="_blank">here</a> for user creation.
                                            </li>
                                            <li style="margin-bottom:8px;">
                                                ...
                                                Follow instructions <a href="<%=request.getScheme() + "://" +
                                                    request.getServerName() +
                                                    ("http".equals(request.getScheme()) && request.getServerPort() == 80 || "https".equals(request.getScheme()) && request.getServerPort() == 443 ? "" : ":" + request.getServerPort() )
                                            %>/secure/view/clients.html" target="_blank">here</a> for client registration.
                                            </li>
                                            <li style="margin-bottom:8px;">
        ...
        <div _ngcontent-vni-31="" class="container" role="contentinfo">
            <div _ngcontent-vni-31="" class="row">
                ...
                <div _ngcontent-vni-31="" class="col-sm-6 text-right">
                    Inquiries or questions, email <a _ngcontent-vni-31="" href="mailto:SITTeam@hhs.gov" tabindex="100">SITTeam@hhs.gov</a>
                </div>
            </div>
            <div _ngcontent-vni-31="" class="row">
                <div _ngcontent-vni-31="" class="col-sm-6 text-left">
