...
public class DataSourceController {
	...
	@ResponseBody
	public DataSource saveOrUpdate(@RequestParam HashMap<String, String> params, @RequestParam("file") MultipartFile file) throws IOException {
		
		return dsService.saveOrUpdate(params,file);
	}
